...
os.chdir(r"C:\Users\deepak.uttam\Documents\backup\bz2")
print(os.getcwd())

start_time = time.perf_counter()

def compression_bz2(filename_in,output_file):
    # Initialize the BZ2Compressor
...
output_file = "recipes_data_data_compress_testing.bz2"
...
# Input bz2 path
filename_in = "recipes_data_data_compress_testing.bz2"
# Output csv file
